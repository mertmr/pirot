...
public class UrunResourceIT {
    ...
    private static final Birim DEFAULT_BIRIM = Birim.ADET;
    private static final Birim UPDATED_BIRIM = Birim.GRAM;
    ...
    public void createUrun() throws Exception {
        ...
        assertThat(testUrun.isActive()).isEqualTo(DEFAULT_ACTIVE);
    }
    ...
    public void updateUrun() throws Exception {
        ...
        assertThat(testUrun.isActive()).isEqualTo(UPDATED_ACTIVE);
    }
