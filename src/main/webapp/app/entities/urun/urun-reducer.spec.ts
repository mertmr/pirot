...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_URUN),
          REQUEST(ACTION_TYPES.UPDATE_URUN),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_URUN),
          REQUEST(ACTION_TYPES.DELETE_URUN),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_URUN),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_URUN actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_URUN),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_URUN),
          payload: resolvedObject,
        },
      ];
