...
import { getEntities, reset } from './virman.reducer';
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('grisiHesabi')}>
                    <Translate contentKey="koopApp.virman.grisiHesabi">Grisi Hesabi</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
              ...
              <tbody>
                {virmanList.map((virman, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`koopApp.Hesap.${virman.grisiHesabi}`} />
                    </td>
                    <td>
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`${match.url}/${virman.id}/edit`} color="primary" size="sm">
                          <FontAwesomeIcon icon="pencil-alt" />{' '}
                          <span className="d-none d-md-inline">
                            <Translate contentKey="entity.action.edit">Edit</Translate>
                          </span>
                        </Button>
                        <Button tag={Link} to={`${match.url}/${virman.id}/delete`} color="danger" size="sm">
