          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="koopApp.satis.kisi">Kisi</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {satisList.map((satis, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{satis.tarih ? <TextFormat type="date" value={satis.tarih} format={APP_DATE_FORMAT} /> : null}</td>
                  ...
                  <td>{satis.kisi ? <Link to={`kisiler/${satis.kisi.id}`}>{satis.kisi.id}</Link> : ''}</td>
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${satis.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
