...
describe('Entities reducer tests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_URUNFIYATHESAP),
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_URUNFIYATHESAP),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_URUNFIYATHESAP actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_URUNFIYATHESAP),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_URUNFIYATHESAP),
          payload: resolvedObject,
        },
      ];
