            ...
            <AvForm model={isNew ? {} : urunFiyatHesapEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField
                  ...
                  name="amortisman"
                  on
                  value={urunFiyatHesap.amortisman}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvField
                  ...
                  on
                  value={urunFiyatHesap.giderPusulaMustahsil}
                  onChange={e => setUrunFiyatHesap(e.target.value)}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvField
                  ...
                  name="dukkanGider"
                  on
                  value={urunFiyatHesap.dukkanGider}
                  onChange={e => updateDukkanGider(e)}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvField
                  ...
                  on
                  value={urunFiyatHesap.kooperatifCalisma}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvField
                  ...
                  name="dayanisma"
                  on
                  value={urunFiyatHesap.dayanisma}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvField id="urun-fiyat-hesap-fire" type="string" className="form-control" name="fire" on value={urunFiyatHesap.fire} />
              </AvGroup>
              <AvGroup>
                <Row>
                  <Col>
                  ...
                  <Col>
                    ...
                    <AvField
                      ...
                      type="string"
                      className="form-control"
                      name="payliBirimFiyat"
                      on
                      value={payliBirimFiyat}
                      disabled
                    />
                  </Col>
                </Row>
