...
export const UrunFiyatHesapUpdate = (props: IUrunFiyatHesapUpdateProps) => {
  ...
  const { urunFiyatHesapEntity, uruns, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : urunFiyatHesapEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="urun-fiyat-hesap-urun">
                  <Translate contentKey="koopApp.urunFiyatHesap.urun">Urun</Translate>
                </Label>
                <AvInput id="urun-fiyat-hesap-urun" type="select" className="form-control" name="urun.id">
                  <option value="" key="0" />
                  {uruns
