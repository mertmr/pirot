...
export const KdvKategorisiDeleteDialog = (props: IKdvKategorisiDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="kdvKategorisiDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="koop-confirm-delete-kdvKategorisi" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
