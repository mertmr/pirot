      ...
      <Col md="8">
        ...
        {gunSonuRaporu.virman ? (
          <Table striped responsive>
            ...
            <tr key={`virman`}>
              <td>
                {gunSonuRaporu.virman.tutar}
              </td>
              <td>
                {gunSonuRaporu.virman.notlar}
              </td>
              <td>
                {gunSonuRaporu.virman.user.login}
              </td>
            </tr>
            </tbody>
          </Table>
        ...
        {gunSonuRaporu.dashboardReports ? (
          <Table striped responsive>
            ...
            <tr key={`virman`}>
              <td>
                {gunSonuRaporu.dashboardReports.kasadaNeVar}
              </td>
              <td>
                {gunSonuRaporu.dashboardReports.gunlukCiro}
              </td>
              <td>
                {gunSonuRaporu.dashboardReports.kartliSatis}
              </td>
              <td>
                {gunSonuRaporu.dashboardReports.nakitSatis}
              </td>
            </tr>
            </tbody>
          </Table>
        ...
        {gunSonuRaporu.nobetHareketleri ? (
          <Table striped responsive>
            ...
            <tr key={`virman`}>
              <td>
                {gunSonuRaporu.nobetHareketleri.kasa}
              </td>
              <td>
                {gunSonuRaporu.nobetHareketleri.pirot}
              </td>
              <td>
                {gunSonuRaporu.nobetHareketleri.fark}
              </td>
              <td>
                {gunSonuRaporu.nobetHareketleri.notlar}
              </td> <td>
              {gunSonuRaporu.nobetHareketleri.tarih ?
                <TextFormat type="date" value={gunSonuRaporu.nobetHareketleri.tarih} format={APP_DATE_FORMAT}/> : null}
            </td>
            </tr>
            </tbody>
          </Table>
