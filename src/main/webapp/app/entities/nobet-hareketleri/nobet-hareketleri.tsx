  ...
  return (
    <div>
      <h2 id="nobet-hareketleri-heading">
        ...
        <Link to={`${match.url}/gun-raporu`} className="btn btn-primary float-right jh-create-entity"
          ...
          <Table responsive>
            ...
            <tr>
              ...
              <th className="hand" onClick={sort('nobetSuresi')}>
                <Translate contentKey="koopApp.nobetHareketleri.nobetSuresi">Nobet Suresi</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th className="hand" onClick={sort('notlar')}>
                <Translate contentKey="koopApp.nobetHareketleri.notlar">Notlar</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
            ...
            {nobetHareketleriList.map((nobetHareketleri, i) => (
              <tr key={`entity-${i}`}>
                ...
                <td>{nobetHareketleri.acilisKapanis}</td>
                <td>
                  {nobetHareketleri.tarih ?
                    <TextFormat type="date" value={nobetHareketleri.tarih} format={APP_DATE_FORMAT}/> : null}
                </td>
