...
import reducer, {
  ...
  partialUpdate,
  reset,
} from './satis-stok-hareketleri.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_SATISSTOKHAREKETLERI_LIST), REQUEST(ACTION_TYPES.FETCH_SATISSTOKHAREKETLERI)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_SATISSTOKHAREKETLERI),
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_SATISSTOKHAREKETLERI_LIST),
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_SATISSTOKHAREKETLERI),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_SATISSTOKHAREKETLERI actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_SATISSTOKHAREKETLERI),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_SATISSTOKHAREKETLERI),
          payload: resolvedObject,
        },
      ];
