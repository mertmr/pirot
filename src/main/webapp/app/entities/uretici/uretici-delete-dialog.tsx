...
export const UreticiDeleteDialog = (props: IUreticiDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="ureticiDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="koop-confirm-delete-uretici" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
