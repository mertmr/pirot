...
import { APP_LOCAL_DATETIME_FORMAT, APP_LOCAL_DATETIME_FORMAT_Z, APP_TIMESTAMP_FORMAT } from 'app/config/constants';
...
export const convertDateToString = date => (date ? moment(date).format(APP_TIMESTAMP_FORMAT) : null);
